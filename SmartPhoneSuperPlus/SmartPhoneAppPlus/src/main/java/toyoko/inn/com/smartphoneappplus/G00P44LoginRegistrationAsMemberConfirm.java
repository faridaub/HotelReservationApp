...
public class G00P44LoginRegistrationAsMemberConfirm extends ActionBarActivity {

    private G01P01ParcelableData obj_g01;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Log.e("DATAX PAGE", "------------------------------------G00P44LoginRegistrationAsMemberConfirm------------------------------------");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.g00_p44_login_registration_as_member_confirm);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_g00_p44_login_registration_as_member_confirm, menu);
        return true;
    }
