...
public class  G00P45LoginRegistrationAsMemberFinish extends ActionBarActivity {

    private G01P01ParcelableData obj_g01;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Log.e("DATAX PAGE", "------------------------------------G00P45LoginRegistrationAsMemberFinish------------------------------------");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.g00_p45_login_registration_as_member_finish);
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_g00_p45_login_registration_as_member_finish, menu);
        return true;
    }
