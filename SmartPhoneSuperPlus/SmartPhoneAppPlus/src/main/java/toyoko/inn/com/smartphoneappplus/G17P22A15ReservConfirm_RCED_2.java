...
public class G17P22A15ReservConfirm_RCED_2 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.e("DATAX PAGE", "------------------------------------G17P22A15ReservConfirm_RCED_2------------------------------------");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.g17_p22_reserv_confirm_edit_delete_rced_2);
    ...
    private void InitialSetupConfiguration() {
        ...
        this.PRCLIST = new String();
        this.PRCINCLDNGTAXLIST = new String();
        this.CRDTCARDEXPRTNDATE = new String();
        ...
        this.srnData = ComLib.getScreen(getApplicationContext());
    ...
    private void CreateFieldProgramatically() {
        ...
        ComActivity.getCommonFieldLayout(getApplicationContext(), parent, FLD_ACC_DATE, la_accmodation_date);
    ...
    private class JSONParse extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            processDialog = new ProgressDialog(G17P22A15ReservConfirm_RCED_2.this);
        ...
        protected Void doInBackground(Void... args) {
            ...
            CUSTRSRVTNNMBR = json.optString(ComConstant.CT_RSRVTNNMBR);
            ...
            RD_PLAN_CODE = json.optString(ComConstant.CT_PLANCODE);
            RD_PLAN_NAME = json.optString(ComConstant.CT_PLANNAME);
            ...
            ECO_FLAG = json.optString(ComConstant.CT_ECOFLAG);
            ...
            BUSINESS_FLAG_DATA = json.optString(ComConstant.CT_BSNSSPACKTYPE);
            BABY_FLAG = json.optString(ComConstant.CT_CHLDRNSHRNGBED);
            CHECKIN_TIME = json.optString(ComConstant.CT_CHCKNTIME);
            PRCLIST   =   json.optString(ComConstant.CT_PRCLIST);
            PRCINCLDNGTAXLIST =   json.optString(ComConstant.CT_PRCINCLDNGTAXLIST);
            OPTNPRC = json.optString(ComConstant.CT_OPTNPRC);
            TOTAL_PRICE = json.optString(ComConstant.CT_TTLPRC);
            TOTAL_PRICE_INC_TAX = json.optString(ComConstant.CT_TTLPRCINCLDNGTAX);
            CRDTCARDEXPRTNDATE= json.optString(ComConstant.CT_CRDTCARDEXPRTNDATE);
            RECEIPTTYPE= json.optString(ComConstant.CT_RECEIPTTYPE);
            RECEIPTNAME= json.optString(ComConstant.CT_RECEIPTNAME);

            try {
                JSONArray jsonData = json.getJSONArray(ComConstant.LT_DLYINFRMTN);
                for (int i = 0; i < jsonData.length(); i++) {
                    JSONObject jsonObject = jsonData.getJSONObject(i);
                    String flag = jsonObject.getString(ComConstant.CT_ECOFLAG);
                    if(flag.equalsIgnoreCase("Y")) {
                        LS_TRGTDATE.add(jsonObject.getString(ComConstant.CT_TRGTDATE));
                    }
    ...
    private void BackTo() {
        Button  back = (Button)findViewById(R.id.g17_p22_back);
    ...
    private void GoToCancelReservation() {
        Button button = (Button)findViewById(R.id.g17_p22_reserv_cancel);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SetupToParceal();
                goTo(G29P25A16ReservConfirmEditDelete_RCED_6.class,COD_NEXT);
            }
        });
    }

    private void GoToReservationUpdate() {
        Button button = (Button)findViewById(R.id.g17_p22_reserv_update);
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                SetupToParceal();
                goTo(G26P23A12ResevInputForm_RCED_3.class,COD_NEXT);
            }
        });
    }
    ...
    private void SetupToView() {
        ...
        if(ECO_FLAG.equalsIgnoreCase("Y")){
            ...
            ecoPlan.append(ComLib.dateConcatWithDateFormate(LS_TRGTDATE));
    ...
    private void ParNightPriceDetails() {
        ...
        for(int nights=0;nights<LS_PRICE.size();nights++) {
            ...
            parnight_price_level.setBackgroundResource(R.drawable.util_confirm_yellow_left);
            ...
            parnigh_price.setBackgroundResource(R.drawable.util_confirm_yellow_right);
        ...
        option_title.setTextSize(11);
        option_title.setTextColor(Color.BLACK);
        option_title.setBackgroundResource(R.drawable.util_confirm_yellow_left);
        ...
        option_price.setTextSize(11);
        option_price.setTextColor(Color.BLACK);
        option_price.setBackgroundResource(R.drawable.util_confirm_yellow_right);
        option_price.setText(OPTNPRC);
        ...
        la_payment_layout.addView(layout3);
            ...
            totalamount_title.setBackgroundResource(R.drawable.util_confirm_yellow_left);
            ...
            la_grand_total.setBackgroundResource(R.drawable.util_confirm_yellow_right);
            la_grand_total.setText(OPTNPRC);
    ...
    private void SetupToParceal() {
        ...
        obj_g01.setRdPlanCode(RD_PLAN_CODE);
        obj_g01.setRdPlanName(RD_PLAN_NAME);
        obj_g01.setNumberOfStayNight(NUMBER_OF_NIGHT);
        obj_g01.setNumberOfPeople(NUMBER_OF_PEOPLE);
        obj_g01.setNumberOfRoom(ComInitData.ST_NUM_OF_ROOMS);
