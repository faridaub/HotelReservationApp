...
public class G28P36A00ReservConfirmEditDelete_RCED_7 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Log.e("DATAX PAGE", "------------------------------------G28P36A00ReservConfirmEditDelete_RCED_7------------------------------------");
        super.onCreate(savedInstanceState);
        setContentView(R.layout.g28_p36_reserv_confirm_edit_delete_setp7);
    ...
    private void G27P24_backToHomePage() {
        Button button = (Button)findViewById(R.id.g28_p36_back7);
