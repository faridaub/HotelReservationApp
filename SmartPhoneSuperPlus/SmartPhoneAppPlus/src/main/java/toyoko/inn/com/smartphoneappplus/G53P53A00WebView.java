...
public class G53P53A00WebView extends Activity {
    private WebView webView;
    private G01P01ParcelableData obj_g01;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        Log.e("DATAX PAGE", "------------------------------------G53P53A00WebView------------------------------------");

        super.onCreate(savedInstanceState);
        setContentView(R.layout.g53_p53_web_view);
    ...
    private void setupWebViewImplementation() {
        ...
        webView.setWebViewClient(new WebViewClient() {
            ProgressDialog progressDialog = new ProgressDialog(G53P53A00WebView.this);
