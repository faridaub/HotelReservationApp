...
public class G21P31_ListViewAdapter extends BaseAdapter {
    ...
    public G21P31_ListViewAdapter(Context context, ArrayList<HashMap<String, String>> arraylist) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        View itemView = inflater.inflate(R.layout.g21_p31_item, parent, false);
        resultp = data.get(position);

        //Hotel Name
        TextView  hotel_name = (TextView) itemView.findViewById(R.id.g21_p31_hotel_name);
        hotel_name.setText(resultp.get(ComConstant.CT_HTLNAME));

        //Member Price
        TextView  member_room_price = (TextView) itemView.findViewById(R.id.g21_p31_mmbrPrc);
        ...
        //Normal Price
        TextView  normal_price = (TextView) itemView.findViewById(R.id.g21_p31_listPrc);
        ...
        //Image
        ImageView  hotel_image = (ImageView) itemView.findViewById(R.id.g21_p31_hotel_image);
